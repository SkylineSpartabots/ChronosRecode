...
public class Indexer extends SubsystemBase {
     ...
     */
    public Indexer() {
        m_leaderIndexer = new TalonFX(Constants.HardwarePorts.rightIndexer); //TODO set the correct ID
        m_followerIndexer = new TalonFX(Constants.HardwarePorts.leftIndexer); //TODO set the correct ID
